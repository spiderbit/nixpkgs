...
in stdenv.mkDerivation rec {
  ...
  meta = {
    description = "Tool to create a Debian/Ubuntu and system in a chroot";
    homepage = https://help.ubuntu.com/community/DebootstrapChroot; # http://packages.debian.org/de/lenny/debootstrap; # http://code.erisian.com.au/Wiki/debootstrap
